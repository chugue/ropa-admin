...
VALUES
    ...
    (3, '라이트블루 데님팬츠', '셀비지 원단으로 만들어진 라이트 불루 데님.', 'XL', 100000, null, 200, 6, true),
    ...
    (3, '슬림 슬랙스', 'Basic하면서 슬림핏으로 어디에나 잘어울리는 슬랙스입니다.', 'XL', 100000, null, 200, 9, true),
...
values ('uuid_브랜드사진1', 'salomon', '/upload/brand/salomon.jpg', 'BRAND', 1, null, null, null, NOW(), true),
       ...
       ('uuid_아이템사진4서브', '아이템사진서브사진4', '/upload/items/item04/detail03.jpg', 'ITEM', null, null, null, 4, NOW(), false),
       ('uuid_아이템사진4서브', '아이템사진서브사진4', '/upload/items/item04/detail04.jpg', 'ITEM', null, null, null, 4, NOW(), false),
       ...
       ('uuid_아이템사진8서브', '아이템사진서브사진8', '/upload/items/item09/detail02.jpg', 'ITEM', null, null, null, 9, NOW(), false);
