...
VALUES
    ...
    (3, '데님 셔츠', 'Basic하면서 유니크한 디자인으로 기본으로 입어도 좋고 이너로 입어도 잘 어울리는 셔츠입니다.', 'L', 100000, null, 200, 9, true),
...
values ('uuid_브랜드사진1', 'salomon', '/upload/brand/salomon.jpg', 'BRAND', 1, null, null, null, NOW(), true),
       ...
       ('uuid_아이템사진7서브', '아이템사진서브사진7', '/upload/items/item07/detail021.jpg', 'ITEM', null, null, null, 7, NOW(), false),
