...
INSERT INTO user_tb (email, password, nick_name, my_name, address, mobile, height, weight, instagram, status,
                     blue_checked)
VALUES ('user1@example.com', '1234', '팀장', '김성훈', '서울특별시 강남구', '010-1234-5678', '175cm', '70kg', '@instagram', '신청 전',
        FALSE),
       ('user2@example.com', '1234', '부팀장', '김주혁', '경기도 분당구', '010-9876-5432', '168cm', '60kg', '@twitter', '승인 대기',
        FALSE),
       ('user3@example.com', '1234', '실장', '박선규', '인천광역시 남동구', '010-5555-5555', '180cm', '75kg', '@facebook', '승인',
        TRUE);
