...
VALUES
    -- 아이템 1부터 10
    (1, 'SCRAPPED 티셔츠(WHITE)', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 100, 1, true),
    (2, '아이템2', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 50, 2, true),
    (3, '아이템3', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 200, 3, true),
    (1, '아이템4', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 100, 4, true),
    (2, '아이템5', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 50, 5, true),
    (3, '아이템6', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 200, 6, true),
    (1, '아이템7', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 100, 7, true),
    (2, '아이템8', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 50, 8, true),
    (3, '아이템9', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 200, 9, true),
    (1, '아이템10', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 100, 10, true),
    (2, '아이템11', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 50, 11, true),
    (3, '아이템12', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 200, 12, true),
    (1, '아이템13', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 100, 13, true),
    (2, '아이템14', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 50, 14, true),
    (3, '아이템15', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 200, 15, true),
    (1, '아이템16', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 100, 16, true),
    (2, '아이템17', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 50, 17, true),
    (3, '아이템18', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 200, 18, true),
    (1, '아이템19', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 100, 19, true),
    (2, '아이템20', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 50, 20, true);
