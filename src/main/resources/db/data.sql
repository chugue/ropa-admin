...
-- 아이템(Items) 더미 데이터 삽입
INSERT INTO items_tb (admin_id, name, description, size, price, discount_rate, discount_price, stock, category_id,
                      status)
VALUES
    -- 아이템 1부터 10
    (1, '아이템1', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 50000, 100, 1, true),
    (2, '아이템2', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 75000, 50, 2, true),
    (3, '아이템3', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 100000, 200, 3, true),
    (1, '아이템4', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 50000, 100, 4, true),
    (2, '아이템5', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 75000, 50, 5, true),
    (3, '아이템6', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 100000, 200, 6, true),
    (1, '아이템7', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 50000, 100, 7, true),
    (2, '아이템8', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 75000, 50, 8, true),
    (3, '아이템9', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 100000, 200, 9, true),
    (1, '아이템10', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 50000, 100, 10, true),
    (2, '아이템11', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 75000, 50, 11, true),
    (3, '아이템12', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 100000, 200, 12, true),
    (1, '아이템13', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 50000, 100, 13, true),
    (2, '아이템14', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 75000, 50, 14, true),
    (3, '아이템15', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 100000, 200, 15, true),
    (1, '아이템16', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 50000, 100, 16, true),
    (2, '아이템17', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 75000, 50, 17, true),
    (3, '아이템18', '이 아이템은 제일 좋습니다.', 'XL', 100000, 0, 100000, 200, 18, true),
    (1, '아이템19', '이 아이템은 아주 좋습니다.', 'M', 50000, 0, 50000, 100, 19, true),
    (2, '아이템20', '이 아이템은 더 좋습니다.', 'L', 75000, 0, 75000, 50, 20, true);
...
values ('사용자사진1', '사용자경로1', 'USER', 1, null, null, NOW(), true),
       ...
       ('아이템서브사진1', '아이템서브사진경로1', 'ITEM', null, null, 1, NOW(), false),
       ('아이템사진2', '아이템사진경로2', 'ITEM', null, null, 2, NOW(), true),
       ('아이템서브사진2', '아이템서브사진경로2', 'ITEM', null, null, 2, NOW(), false),
       ('아이템사진3', '아이템사진경로3', 'ITEM', null, null, 3, NOW(), true),
       ('아이템서브사진3', '아이템서브사진경로3', 'ITEM', null, null, 3, NOW(), false),
       ('아이템사진4', '아이템사진경로4', 'ITEM', null, null, 4, NOW(), true),
       ('아이템서브사진4', '아이템서브사진경로4', 'ITEM', null, null, 4, NOW(), false),
       ('아이템사진5', '아이템사진경로5', 'ITEM', null, null, 5, NOW(), true),
       ('아이템서브사진5', '아이템서브사진경로5', 'ITEM', null, null, 5, NOW(), false),
       ('아이템사진6', '아이템사진경로6', 'ITEM', null, null, 6, NOW(), true),
       ('아이템서브사진6', '아이템서브사진경로6', 'ITEM', null, null, 6, NOW(), false),
       ('아이템사진7', '아이템사진경로7', 'ITEM', null, null, 7, NOW(), true),
       ('아이템서브사진7', '아이템서브사진경로7', 'ITEM', null, null, 7, NOW(), false),
       ('아이템사진8', '아이템사진경로8', 'ITEM', null, null, 8, NOW(), true),
       ('아이템서브사진8', '아이템서브사진경로8', 'ITEM', null, null, 8, NOW(), false),
       ('아이템사진9', '아이템사진경로9', 'ITEM', null, null, 9, NOW(), true),
       ('아이템서브사진9', '아이템서브사진경로9', 'ITEM', null, null, 9, NOW(), false),
       ('아이템사진10', '아이템사진경로10', 'ITEM', null, null, 10, NOW(), true),
       ('아이템서브사진10', '아이템서브사진경로10', 'ITEM', null, null, 10, NOW(), false),
       ('아이템사진11', '아이템사진경로11', 'ITEM', null, null, 11, NOW(), true),
       ('아이템서브사진11', '아이템서브사진경로11', 'ITEM', null, null, 11, NOW(), false),
       ('아이템사진12', '아이템사진경로12', 'ITEM', null, null, 12, NOW(), true),
       ('아이템서브사진12', '아이템서브사진경로12', 'ITEM', null, null, 12, NOW(), false),
       ('아이템사진13', '아이템사진경로13', 'ITEM', null, null, 13, NOW(), true),
       ('아이템서브사진13', '아이템서브사진경로13', 'ITEM', null, null, 13, NOW(), false),
       ('아이템사진14', '아이템사진경로14', 'ITEM', null, null, 14, NOW(), true),
       ('아이템서브사진14', '아이템서브사진경로14', 'ITEM', null, null, 14, NOW(), false),
       ('아이템사진15', '아이템사진경로15', 'ITEM', null, null, 15, NOW(), true),
       ('아이템서브사진15', '아이템서브사진경로15', 'ITEM', null, null, 15, NOW(), false),
       ('아이템사진16', '아이템사진경로16', 'ITEM', null, null, 16, NOW(), true),
       ('아이템서브사진16', '아이템서브사진경로16', 'ITEM', null, null, 16, NOW(), false),
       ('아이템사진17', '아이템사진경로17', 'ITEM', null, null, 17, NOW(), true),
       ('아이템서브사진17', '아이템서브사진경로17', 'ITEM', null, null, 17, NOW(), false),
       ('아이템사진18', '아이템사진경로18', 'ITEM', null, null, 18, NOW(), true),
       ('아이템서브사진18', '아이템서브사진경로18', 'ITEM', null, null, 18, NOW(), false),
